...
public class NewComplaint extends AppCompatActivity implements TaskCompleted,View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //pg = new ProgressDialog(NewComplaint.this);
        ...
        if(savedInstanceState == null)
        {
            ...
            else{tv_error.setText("No Network");
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    try {
                        ...
                        Log.d("New Complaint Position",String.valueOf(position));Log.d("New Complaint id",String.valueOf(id));
