...
public class AppointedComplaint extends AppCompatActivity implements TaskCompleted,View.OnClickListener{
   // String code = "3"; // 1 for new complaints ,2 for specific , 3 for appointed
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* ComplaintModel cm = new ComplaintModel("1","asd","er","1212");
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    try {
                        ...
                        Log.d("AppointedComplaint",String.valueOf(position));Log.d("Appointedid",String.valueOf(id));
