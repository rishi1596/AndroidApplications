...
public class NewSpecificComplaint extends AppCompatActivity implements TaskCompleted,View.OnClickListener{
    ...
    String array_of_day_code[] = {"Sun","Mon","Tues","Wed","Thurs","Fri","Sat"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // days_code_week.get("Sat")

        try {
            SharedPreferences sp = getSharedPreferences("settings",0);
            String engineers = sp.getString("engineers",null);
            JSONArray engineers_array = new JSONArray(engineers);
            //Log.d("engineerrr", String.valueOf(engineers_array));
            String engineer_name[] = new String[engineers_array.length()+1];
            engineer_name[0] = "Select Engineer";
            for(int i = 1 ;i<engineers_array.length()+1;i++)
            {
                engineer_name[i] =String.valueOf(engineers_array.get(i-1));
            }
            ...
            if(!in_company.equalsIgnoreCase("null"))
            {
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            if(!in_address.matches(AddressPattern))
            {
            ...
            {
                tv_error.setText(R.string.spinner_error);
                tv_error.setVisibility(View.VISIBLE);
            }
            ...
            else if(in_allotment_date_slot.equals("0"))
            {
                ...
                try {
                    ...
                    if (networkInfo != null && networkInfo.isConnected() && networkInfo.isAvailable()) {
                        ...
                        send_details.put("code", code); //code 1 2 n 3    2 for update
    ...
    private class DateAsync extends AsyncTask<Void,Void,String>
    {
        ...
        int code=0,current_time_int,current_day_int,current_day_string_to_hash_map,current_month;
        @Override
...
*/
        ...
        protected String doInBackground(Void... params) {
           // if(current_day_string.equalsIgnoreCase("sun"))
           // {
                //code = 2;
                provide_appointment_dates(current_day_int, current_month, current_day_string_to_hash_map);
            //}
           // else{
              //  code = 1;  //CHANGE IT TO 1
              //  provide_appointment_dates(current_day_int,current_month,current_day_string,current_day_string_to_hash_map,code);
           // }
