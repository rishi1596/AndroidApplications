...
public class InProcessComplaintActivity extends AppCompatActivity implements TaskCompleted,View.OnClickListener {
        ...
        protected void onCreate (@Nullable Bundle savedInstanceState){
            ...
            if (savedInstanceState == null) {
                ...
                } else {tv_error.setText(R.string.no_network);
    ...
    public void updateComplaintStatus(String data) {
        new ComplaintsAsync(AllComplaintsStatusActivity.allcomplaints).execute(data);
    }  //For Specific Complaint Activity
